...
var kboosh_id = "475220757723742229";
                    var i = "0";
                    var x = "0";
...
kboosh.on("messageCreate", (msg) => {
    if(msg.author.id !== "426823056418406418") return kboosh.createMessage('__**This Command is only for the bot Owner**__');
    if(msg.content === "^BotSoUnDEeEe") {
